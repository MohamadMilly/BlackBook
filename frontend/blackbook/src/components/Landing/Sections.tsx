...
export function LandingSections(): JSX.Element {
  return (
    <main className="px-4 grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6 mt-6">
      <section className="mt-4 md:col-start-1 md:col-end-2">
        <h2 className="text-4xl mb-2">Why BlackBook?</h2>
        <p className="relative max-w-xl mx-auto text-base sm:text-lg text-neutral-200 font-medium leading-relaxed">
      ...
      <section className="mt-4 md:col-start-2 md:col-end-3">
        <h2 className="text-4xl mb-2">Features</h2>
        <ul className="px-4 list-decimal text-base sm:text-lg text-neutral-200 font-medium leading-relaxed">
