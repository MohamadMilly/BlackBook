...
export function InlinePanel({
  ...
  return (
    <aside
      className={`fixed right-0 top-0 z-1000 bg-black ${float ? "" : "md:static"} transition-all duration-300 ease-in-out shrink-0 -col-end-1 row-start-2 row-end-3 min-h-0
